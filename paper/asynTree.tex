...
Encourage readers to take my Python code, make a meaninful change to the command tree, then see if behavior changes as expected, and see if tree compare test also reveals the change.
